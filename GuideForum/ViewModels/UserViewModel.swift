...
final class UserViewModel: ObservableObject {
    @Published var user = User(name: "Natasha Belova", email: "blvantla@gmail.com", status: "Hi everyone!")
